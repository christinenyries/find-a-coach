<template>
    <form @submit.prevent="submitForm">
        ...
        <div class="form-control" :class="{'invalid': !areas.isValid}">
            <h3 for="areas">Areas</h3>
            <div>
                <input type="checkbox" name="frontend" id="frontend" value="frontend" v-model="areas.val"
            ...
            <div>
                <input type="checkbox" name="career" id="career" value="career" v-model="areas.val"
                    @blur="clearValidity('areas')">
